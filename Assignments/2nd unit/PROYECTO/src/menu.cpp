...
#include "../include/ValidacionPlaca.h"
...
void menuGestionPropietarios(ListaPropietarios &listaPropietarios)
{
    ...
    while (!salirSubmenu)
    {
        ...
        case 0:
            ...
            listaPropietarios.guardarArchivo("output//propietarios.txt");
            break;
        case 1:
...
void menu(ListaCircularDoble<Coche> &lista, ListaCircularDoble<Coche> &listaHistorial, ListaPropietarios &listaPropietarios)
{
    ...
    string archivo = "output//autos.txt";
    string archivoHistorial = "output//autos_historial.txt";
    ...
    while (true)
    {
        ...
        case 0:
        {
            ...
            lista.insertar(nuevoCoche, "output//autos.txt");
            listaHistorial.insertar(nuevoCoche, "output//autos_historial.txt");
            break;
        }
        case 1:
        {
        ...
        case 7:
        {
            ...
            cout << "========================================" << endl;
            cout << "========================================" << endl;
            string archivo = "resources/ayuda.html";
    ...
    while (!salirSubmenu)
    {
        ...
        else if (seleccionMetodo == 2)
        {
            ...
            case 0:
                ...
                lista.GuardarArchivo("output//autos.txt");
                cout << "Lista ordenada por placa y guardada exitosamente." << endl;
                break;
            case 1:
